...
import loveBackground from '../assets/love.jpg';
...
const App = () => {
  ...
  const containerStyle: React.CSSProperties = {
    ...
    left: 0,
    overflow: 'hidden',
    background: `linear-gradient(135deg, rgba(255, 107, 157, 0.7), rgba(165, 9, 234, 0.7), rgba(165, 94, 234, 0.9)), url(${loveBackground})`,
